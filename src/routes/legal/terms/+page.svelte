...
<div class="mx-64 py-4 print:mx-20">
	...
	<h1 class="text-xl print:font-normal w-screen">
		Terms of Service of <span class="screen:font-bold">Luyx.dev, Count.bot, Treefarmer.xyz</span>
	</h1>
	...
	<ol class="list-decimal w-full print:w-screen">
		<li class="text-4xl mb-4">
			...
			<ul>
				...
				<li class="text-lg my-3">
					...
					https://luyx.dev, https://count.bot, and https://treefarmer.xyz, and other applications, websites, 
					or services operated by Luyx LLC.
				</li>
				<li class="text-lg my-3">
				...
				<li class="text-lg my-3">
					If you do not agree with (or cannot comply with) Agreements, then you may not use our Service. These 
					Terms apply to all visitors, users and others who wish to access or use our Service.
				</li>
			</ul>
		</li>
		<li class="text-4xl mb-4 w-full print:w-screen">
			...
			<ul>
				<li class="text-lg mt-2 my-3">
					<span class="font-bold">SERVICE</span> means the https://luyx.dev website, the https://count.bot
					website, the https://treefarmer.xyz website, and any other applications, websites, and services operated 
					by Luyx LLC.
				</li>
				<li class="text-lg my-3">
					<span class="font-bold">PERSONAL DATA</span> means data about a living individual who can be
				...
				<li class="text-lg my-3">
					<span class="font-bold">USAGE DATA</span> is data collected automatically either generated
					by the use of Service or from Service infrastructure itself (for example, the duration of a
					page visit).
				</li>
				<li class="text-lg my-3">
					<span class="font-bold">COOKIES</span> are small files stored on your device (computer or mobile
					device).
				</li>
				<li class="text-lg my-3">
					<span class="font-bold">DATA CONTROLLER</span> means a natural or legal person who (either
					alone or jointly or in common with other persons) determines the purposes for which and the
					manner in which any personal data are, or are to be, processed. For the purpose of this Privacy
					Policy, we are a Data Controller of your data.
				</li>
				<li class="text-lg my-3">
					<span class="font-bold">DATA PROCESSORS</span> (OR SERVICE PROVIDERS) means any natural or
					legal person who processes the data on behalf of the Data Controller. We may use the services
					of various Service Providers in order to process your data more effectively.
				</li>
				<li class="text-lg my-3">
					<span class="font-bold">DATA SUBJECT</span> is any living individual who is the subject of
					Personal Data.
				</li>
				<li class="text-lg my-3">
					<span class="font-bold">THE USER</span> is the individual using our Service. The User corresponds
		...
		<li class="text-4xl mb-4 w-full print:w-screen">
			...
			<ul>
				<li class="text-lg mt-2 my-3">
					...
					communications from us by following the unsubscribe link or by emailing at contact@luyx.dev.
				</li>
			</ul>
		</li>
		<li class="text-4xl mb-4 w-full print:w-screen">
			...
			<ul>
				<li class="text-lg mt-2 my-3">
					...
					(“<span class="font-bold">Purchase</span>”), you may be asked to supply certain information relevant 
					to your Purchase including, without limitation, your credit card number, the expiration date of your 
		...
		<li class="text-4xl mb-4">
			...
			<ul>
				<li class="text-lg mt-2 my-3">
					Some parts of Service are billed on a subscription basis (“Subscription(s)”). You will be billed in advance on 
				...
				<li class="text-lg my-3">
					...
					unless you cancel it orLuyx LLCcancels it. You may cancel your Subscription renewal either through your online 
					account management page or by contacting Luyx LLC customer support team.
				</li>
				<li class="text-lg my-3">
					A valid payment method, including credit card or PayPal, is required to process the payment for your 
					subscription. You shall provide Luyx LLC with accurate and complete billing information including full name, 
					address, state, zip code, telephone number, and a valid payment method information. By submitting such payment 
					information, you automatically authorize Luyx LLC to charge all Subscription fees incurred through your account 
					to any such payment instruments.
				</li>
				<li class="text-lg my-3">
					Should automatic billing fail to occur for any reason, Luyx LLC will terminate your Subscription and revoke all 
					benefits included along with the Subscription.
				</li>
			</ul>
		</li>
		<li class="text-4xl mb-4">
			...
			<ul>
				<li class="text-lg mt-2 my-3">
					Luyx LLC, in its sole discretion and at any time, may modify Subscription fees for the Subscriptions. Any 
					Subscription fee change will become effective at the end of the then- current Billing Cycle.
				</li>
				<li class="text-lg my-3">
					Luyx LLC will provide you with a reasonable prior notice of any change in Subscription fees to give you an 
		...
		<li class="text-4xl mb-4">
			...
			<ul class="text-lg mt-2 my-3">
				Content found on or through this Service are the property of Luyx LLC or used with permission. You may not distribute, 
				modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for 
				commercial purposes or for personal gain, without express advance written permission from us.
			</ul>
			<ul class="text-lg my-3">
				Luyx LLC regularly ensures that the content provided on this Website infringes no applicable 
				legal provisions or third-party rights. However, it may not always be possible to achieve such a result.
				In such cases, without prejudice to any legal prerogatives of users to enforce their rights, you are kindly asked 
				to preferably report related complaints to our email contained in this document.
			</ul>
		</li>
		<li class="text-4xl mb-4">
			Prohibited Uses
		...
		<li class="text-4xl mb-4">
			...
			<ul class="text-lg mt-2 my-3">
				Service is intended only for access and use by individuals at least thirteen (13) years old. By accessing or using 
				any of Company, you warrant and represent that you are at least thirteen (13) years of age and with the full authority, 
				right, and capacity to enter into this agreement and abide by all of the terms and conditions of Terms. If you are not 
				at least thirteen (13) years old, you are prohibited from both the access and usage of Service.
			</ul>
		</li>
		<li class="text-4xl mb-4">
			Accounts
			...
			<ul class="text-lg my-3">
				We reserve the right to refuse service, terminate accounts, remove or edit content, or cancel orders or subscriptions in our sole discretion.
			</ul>
		</li>
		<li class="text-4xl mb-4">
			...
			<ul class="text-lg mt-2 my-3">
				...
				the exclusive property of Luyx LLC and its licensors. Service is protected by copyright, trademark, and other laws of 
				the United States. Our trademarks and trade dress may not be used in connection with any product or service without the 
				prior written consent of Luyx LLC.
			</ul>
		</li>
		<li class="text-4xl mb-4">
			...
			<ul>
				<li class="text-lg mt-2 my-3">
					You may provide us either directly at contact@luyx.dev or via third party sites and tools with information and 
					...
					information from you or any third party; and (iv) Company is not under any obligation of confidentiality with respect 
					to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to applicable 
		...
		<li class="text-4xl mb-4">
			...
			<ul class="text-lg mt-2 my-3">
				Our Service may contain links to third party web sites or services that are not owned or controlled by Luyx LLC.
			</ul>
			<ul class="text-lg my-3">
				Luyx LLC has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third 
				party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.
			</ul>
			<ul class="text-lg my-3">
				YOU ACKNOWLEDGE AND AGREE THAT LUYX LLC SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR INDIRECTLY, FOR ANY DAMAGE 
		...
		<li class="text-4xl mb-4">
			...
			<ul class="text-lg mt-2 my-3">
				...
				WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THEIR SERVICES, OR THE INFORMATION, CONTENT OR
				 MATERIALS INCLUDED THEREIN. YOU EXPRESSLY AGREE THAT YOUR USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES 
			...
			<ul class="text-lg my-3">
				...
				WILL BE CORRECTED, THAT THE SERVICES OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS
				 OR THAT THE SERVICES OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE SERVICES WILL OTHERWISE MEET YOUR NEEDS OR 
				 EXPECTATIONS.
			</ul>
			<ul class="text-lg my-3">
		...
		<li class="text-4xl mb-4">
			...
			<ul class="text-lg mt-2 my-3">
				...
				INSTITUTED), WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT OF OR IN CONNECTION 
				WITH THIS AGREEMENT, INCLUDING WITHOUT LIMITATION ANY CLAIM FOR PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THIS 
				AGREEMENT AND ANY VIOLATION BY YOU OF ANY FEDERAL, STATE, OR LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF COMPANY 
				HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON 
				THE PART OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES 
				WILL THERE BE CONSEQUENTIAL OR PUNITIVE DAMAGES. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF PUNITIVE, 
		...
		<li class="text-4xl mb-4">
			Governing Law
			<ul class="text-lg mt-2 my-3">
				These Terms shall be governed and construed in accordance with the laws of State of Virginia without regard to its conflict 
				of law provisions.
			</ul>
			<ul class="text-lg my-3">
