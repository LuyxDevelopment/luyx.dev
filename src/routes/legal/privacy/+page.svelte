<div class="container mx-10 my-10 flex flex-col">
  <p class="print:hidden">A printable version is available</p>
  <h1 class="w-screen text-xl print:font-normal">
    Privacy Policy of <span class="screen:font-bold">Luyx.dev, Count.bot, Treefarmer.xyz</span>
  </h1>
  <h1 class="mb-5 w-screen text-xl print:text-sm">
    Effective date: <span class="screen:font-bold print:text-sm">08/01/2023</span>
  </h1>
  <ol class="mx-10 w-full list-decimal print:w-screen">
    <li class="mb-4 text-4xl">
      Introduction
      <ul>
        <li class="my-3 mt-4 text-lg">
          Welcome to Luyx LLC. Luyx LLC (“us”, “we”, or “our”) operates https://luyx.dev,
          https://count.bot, and https://treefarmer.xyz (hereinafter referred to as “Services”).
        </li>
        <li class="my-3 text-lg">
          Our Privacy Policy governs your visit to https://luyx.dev, https://count.bot, and
          https://treefarmer.xyz and explains how we collect, safeguard and disclose information
          that results from your use of our Services.
        </li>
        <li class="my-3 text-lg">
          We use your data to provide and improve our Services. By using Servicse, you agree to the
        ...
        <li class="my-3 text-lg">
          Our Terms and Conditions (“Terms”) govern all use of our Services and together with the
          Privacy Policy constitutes your agreement with us (“agreement”).
        </li>
      </ul>
    </li>
    <li class="mb-4 w-full text-4xl print:w-screen">
      Definitions
      <ul>
        <li class="my-2 mt-4 text-lg">
          <span class="font-bold">SERVICES</span> means the https://luyx.dev website, the https://count.bot
          website, and the https://treefarmer.xyz website operated by Luyx LLC.
        </li>
    ...
    <li class="mb-4 w-full text-4xl print:w-screen">
      ...
      <ul>
        <li class="mt-4 text-lg font-bold">Personal Data</li>
        ...
        <li class="mt-4 text-lg font-bold">Usage Data</li>
        <li class="my-2 text-lg">
          We may also collect information that your browser sends whenever you visit our Services or
          when you access our Services by or through a mobile device (“Usage Data”).
        </li>
        <li class="my-2 text-lg">
        ...
        <li class="my-2 text-lg">
          When you access our Services with a mobile device, this Usage Data may include information
        ...
        <li class="mt-4 text-lg font-bold">Tracking Cookies Data</li>
        <li class="my-2 text-lg">
        ...
        <li class="my-2 text-lg">
          ...
          track information and to improve and analyze our Services.
        </li>
        <li class="my-2 text-lg">
        ...
        <li class="my-2 text-lg">Examples of Cookies we use:</li>
        <ol class="list-lettered text-lg">
          <li class="my-2">
            <span class="font-bold">Session Cookies:</span> We use Session Cookies to operate our Services.
          </li>
          <li class="my-2">
            <span class="font-bold">Preference Cookies:</span> We use Preference Cookies to remember
            your preferences and various settings.
          </li>
          <li class="my-2">
            <span class="font-bold">Security Cookies:</span> We use Security Cookies for security purposes.
          </li>
          <li class="my-2">
            <span class="font-bold">Advertising Cookies:</span> Advertising Cookies are used to serve
            you with advertisements that may be relevant to you and your interests.
          </li>
        </ol>
        <li class="mt-4 text-lg font-bold">Other Data</li>
        <li class="my-2 text-lg">
          While using our Services, we may also collect the following information: sex, age, date of
          birth, place of birth, passport details, citizenship, registration at place of residence
          and actual address, telephone number (work, mobile), details of documents on education,
      ...
      <ul>
        <li class="my-4 text-lg">
          ...
          <ol class="list-lettered text-lg">
            ...
            <li class="my-2">to detect, prevent and address technical issues;</li>
            <li class="my-2">to fulfill any other purpose for which you provide it;</li>
            <li class="my-2">
            ...
            <li class="my-2">in any other way we may describe when you provide the information;</li>
    ...
    <li class="mb-4 text-4xl">
      ...
      <ul>
        ...
        <li class="my-3 text-lg">
          Luyx LLC will take all the steps reasonably necessary to ensure that your data is treated
          ...
          <ol class="list-lettered text-lg">
            ...
            <li class="my-3">
              ...
              <ol class="list-roman">
                ...
                <li class="my-2">to fulfill the purpose for which you provide it;</li>
                <li class="my-2">
    ...
    <li class="mb-4 text-4xl">
      ...
      <ul class="my-3 text-lg">
        ...
        removed from our systems, please email us at contact@luyx.dev
      </ul>
      <ul class="my-3 text-lg">
    ...
    <li class="mb-4 text-4xl">
      ...
      <ul class="text-lg">
        ...
        <ol class="list-lettered">
          ...
          <li class="my-2">
            users are able to change their personal information by emailing us at contact@luyx.dev
          </li>
          <li class="my-2">
            the right to data portability. You have the right to be provided with a copy of your
            Personal Data in a structured, machine-readable and commonly used format;
      ...
      <ul class="my-3 text-lg">Our Policy on “Do Not Track” Signals:</ul>
      <ul class="mt-2 text-lg">
        We currently do not recognize Do Not Track signals. Do Not Track is a preference you can set
    ...
    <li class="mb-4 text-4xl">
      ...
      <ul>
        ...
        <ul class="my-3 text-lg font-bold">GitHub</ul>
        <ul class="my-3 text-lg">GitHub is provided by GitHub, Inc.</ul>
        <ul class="my-3 text-lg">
    ...
    <li class="mb-4 text-4xl">
      ...
      <ul>
        ...
        <li class="my-3 text-lg">The payment processors we work with are:</li>
        <li class="my-3 text-lg">
    ...
    <li class="mb-4 text-4xl">
      ...
      <ul class="my-3 text-lg">By email: contact@luyx.dev.</ul>
    </li>
  </ol>
</div>
